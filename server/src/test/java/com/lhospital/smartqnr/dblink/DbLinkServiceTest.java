...
class DbLinkServiceTest {
  ...
  @Test
  @DisplayName("숫자형 문자열은 숫자로 바인딩한다(정수 컬럼 비교 오류 방지)")
  void coercesNumbers() {
    assertEquals(10001L, DbLinkService.coerce("10001"));
    assertEquals(new java.math.BigDecimal("1.5"), DbLinkService.coerce("1.5"));
